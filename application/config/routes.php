...
$route['admin/dashboard/orders'] = 'admins/admin_orders/1';
$route['admin/dashboard/orders/(:any)'] = 'admins/admin_orders/$1';
...
$route['admin_edit_product/(:any)'] = 'admins/admin_edit_product/$1';
...
$route['pokemon/types/(:any)'] = "mains/getallpoketypes/$1/1";
...
$route['order/(:any)'] = 'admins/view/$1';
$route['translate_uri_dashes'] = FALSE;
$route['orders'] = 'admins/loadorders';
$route['products'] = 'admins/loadproducts';
$route['edit/delete/image/(:any)/(:any)'] = 'admins/deletepicture/$1/$2';
$route['addnewtype'] = 'admins/add_new_type';
